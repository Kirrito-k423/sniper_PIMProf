...
int64_t BUStep(const Graph &g, pvector<NodeID> &parent, Bitmap &front,
  ...
  next.reset();
#if defined SNIPER || defined VTUNE || defined PIMPROF || defined SNIPERTEST
...
#if defined SNIPER || defined VTUNE || defined PIMPROF
  PIMPROF_BEGIN_REG_PARALLEL
#endif
...
int main(int argc, char* argv[]) {
  #if defined ZSIM || defined SNIPER || defined PIMPROF || defined SNIPERTEST
